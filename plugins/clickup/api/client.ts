import { CLICKUP_API_BASE, CLICKUP_ORIGIN, MAX_RESPONSE_BYTES, MAX_RESPONSE_LINES } from "../constants.ts";
...
export class ClickUpClient {
  ...
  async request(params: ClickUpRequestParams, parentSignal?: AbortSignal) {
    ...
    try {
      ...
      const hasBody = params.body !== undefined && params.method !== "GET" && params.method !== "DELETE";
      ...
      return {
        content: [{ type: "text" as const, text: text || `ClickUp request succeeded (${response.status}).` }],
